...
class H(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if p=='/api/version':
            self.sendj({'version':'5.6.2-R9.2A','channel':'DAR-MUQTANYAT-R9.2A-SAFE-LOAD','marketFirstLaunch':False,'liveVideoProvider':'livekit','liveVideoConfigured':livekit_configured()}); return
        if p=='/account-logout':
