...
window.marketRequestReset = async (id) => {
  if (!confirm("إعادة المقتنى إلى سجل صاحبه؟\nسيُغلق الطلب الحالي وتتحرر الكمية، ولن يُعاد عرضه في السوق تلقائيًا.")) return;
  try {
