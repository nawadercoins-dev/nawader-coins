...
function fill(data){
 ...
 const add=$('sellerAddCollectible');if(add){const s=state.storeFilter==='collectibles'?'collectibles':'coins';add.href='/account?store='+s+'#submissionPanel';add.textContent=state.storeFilter==='collectibles'?'إضافة مقتنى في نوادر المقتنيات':'إضافة مقتنى في نوادر العملات';}
